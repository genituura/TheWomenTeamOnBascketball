// Создание кода T4 для модели "C:\Users\User\OneDrive\Рабочий стол\ИСРПО ЛР1\LR1\Женская сборная по баскетболу\Женская сборная по баскетболу\Model\Model1.edmx" включено. 
